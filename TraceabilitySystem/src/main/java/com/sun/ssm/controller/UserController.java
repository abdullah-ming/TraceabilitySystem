package com.sun.ssm.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.sun.ssm.service.AddorSearchService;
import com.sun.ssm.service.UserService;
...
public class UserController {
    ...
    public boolean add(HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        if(addorSearchService.addMsg(username,ID,pro,lowpoint,admin)!=null){
    ...
    public JSONArray search(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        for(int i=0;i<total;i++){
            ...
            if(username.equals(name)) {
                ...
                json.put("pro", addorSearchService.getProductRecord(BigInteger.valueOf(i)));
